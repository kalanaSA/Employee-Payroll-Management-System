...
public class MainMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(30, 570, 90, 14);

        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/emps/images/Add_Employee.png"))); // NOI18N
        jButton2.setText("Emploee Manager");
        ...
        jButton2.setBounds(421, 420, 190, 59);

        jButton7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/emps/images/Payment.png"))); // NOI18N
        ...
        jButton7.setBounds(800, 500, 170, 59);

        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/emps/images/Search_1.png"))); // NOI18N
        ...
        jButton3.setBounds(620, 420, 170, 59);

        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/emps/images/logout.png"))); // NOI18N
        ...
        jButton1.setBounds(930, 20, 30, 30);

        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/emps/images/Update.png"))); // NOI18N
        ...
        jButton5.setBounds(420, 500, 190, 59);

        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/emps/images/Allowance.png"))); // NOI18N
        ...
        jButton4.setBounds(800, 420, 170, 59);

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("emp");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(120, 570, 100, 15);

        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/emps/images/Deduction.png"))); // NOI18N
        ...
        jButton6.setBounds(620, 500, 170, 59);

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/emps/images/bk2.jpg"))); // NOI18N
        ...
        setSize(new java.awt.Dimension(1018, 683));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
             Date currentDate = GregorianCalendar.getInstance().getTime();
                    ...
                    String reg ="INSERT INTO audit(empId,date,status) VALUES('"+value3+"','"+value1+" / "+value2+"','Logged out')";
